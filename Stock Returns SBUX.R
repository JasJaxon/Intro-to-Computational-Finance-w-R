# Lesson: learning how to select stock data between certain dates, subset directly on dates,
# plot the data price, calculate simple returns, graphically compare simple and continuously 
# compounded returns, and calculate growth of $1 invested in SBUX
...
bothreturns <- cbind(sbux_ret, sbux_ccret)
head(bothreturns)
